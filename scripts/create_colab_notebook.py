    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "        print(f\"[HARDSUB] Sanitized subtitle written in clean UTF-8: {temp_sub_path}\")\n",
                "    except Exception as e:\n",
                "        print(f\"[HARDSUB] ⚠️ Could not write {temp_sub_path}: {e}\")\n",
                "        temp_sub_path = srt_path\n",
                "        temp_dir = os.path.dirname(os.path.abspath(srt_path))\n",
                "\n",
                "    # Sanitize output filename: strip brackets, parentheses, and quotes\n",
                ...
                "\n",
                "    # 3. Robust subtitle filter configuration (executed with cwd=temp_dir)\n",
                ...
                "        print(f\"[HARDSUB] ✅ Hardsubbing complete! Video: {os.path.basename(output_path)} ({mb:.1f} MB)\")\n",
                "        return output_path\n",
                "\n",
                "    return video_path"
            ]
