    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "    \"\"\"Convert SRT to ASS format with Arabic styling. Resilient against CRLF, BOM, timestamp variations.\"\"\"\n",
                "    # Pre-clean: strip BOM, normalize all line endings to Unix LF\n",
