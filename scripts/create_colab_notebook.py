    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "    \"\"\"Enforce exact token matching for show_name against torrent title to reject false matches (e.g. Breaking Brad).\"\"\"\n",
                ...
                "\n",
                "def fetch_eztv_torrent(show_name, season_num=1, episode_num=1, imdb_id=None, preferred_quality=\"1080p\"):\n",
                "    \"\"\"Query EZTV API for TV episode torrents with mirror failover, swarm fallback, and quality prioritization.\"\"\"\n",
                "    episode_tag = f\"S{season_num:02d}E{episode_num:02d}\"\n",
                "    print(f\"[EZTV] Searching torrent for {show_name} {episode_tag} (IMDb: {imdb_id or 'None'})...\")\n",
                ...
                "                            })\n",
                "                    if matched_torrents:\n",
                "                        print(f\"[EZTV] Connected to {mirror} (Page {page}): found {len(matched_torrents)} matching releases for {episode_tag}\")\n",
                "                        break\n",
                "            except Exception: continue\n",
                "    valid_torrents = [t for t in matched_torrents if t[\"seeds\"] > 0]\n",
                "    if not valid_torrents and imdb_id:\n",
                "        print(f\"[EZTV] No active releases with seeds > 0 on EZTV. Checking public torrent swarm indexer...\")\n",
                "        try:\n",
                ...
                "                trackers_q = \"\".join(f\"&tr={quote(tr)}\" for tr in [\"udp://tracker.opentrackr.org:1337/announce\", \"udp://open.stealth.si:80/announce\", \"udp://tracker.torrent.eu.org:451/announce\", \"udp://tracker.bittor.pw:1337/announce\", \"udp://public.popcorn-tracker.org:6969/announce\"])\n",
                ...
                "                            \"title\": rel_title,\n",
                "                            \"torrent_url\": None,\n",
                "                            \"magnet_uri\": f\"magnet:?xt=urn:btih:{info_hash}&dn={quote(rel_title)}{trackers_q}\",\n",
                "                            \"seeds\": s_seeds,\n",
                "                            \"size\": \"Unknown\",\n",
                "                            \"source\": \"Torrentio\"\n",
                "                        })\n",
                "        except Exception as e:\n",
                "            print(f\"[EZTV] Public swarm fallback error: {e}\")\n",
                ...
                "    print(f\"[EZTV] ✅ Selected release: '{selected_torrent.get('title')}' ({actual_quality}, seeds: {selected_torrent.get('seeds')}, source: {selected_torrent.get('source', 'EZTV')})\")\n",
                "    return {\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "    Optimized for 4-core CPU using libx264 veryfast preset, crf 23, threads 4, and audio copy.\n",
                "    \"\"\"\n",
                ...
                "    print(f\"[HARDSUB] Burning Arabic subtitles into 1080p frames (CPU 4 threads, veryfast, crf 23): output_1080p.mp4 in {staging_dir}...\")\n",
                "    cmd = [\n",
                "        \"ffmpeg\", \"-y\", \"-nostdin\",\n",
                "        \"-i\", ffmpeg_input,\n",
                "        \"-vf\", sub_filter_rel,\n",
                ...
                "\n",
                "    ffmpeg_log = os.path.join(staging_dir, \"ffmpeg_process.log\")\n",
                "    print(f\"[HARDSUB] Downscaling to 720p (scale=-2:720, crf 24, 4 threads): {os.path.basename(input_1080p_path)} -> {os.path.basename(output_720p_path)}...\")\n",
                "    cmd = [\n",
                "        \"ffmpeg\", \"-y\", \"-nostdin\",\n",
                "        \"-i\", input_1080p_path,\n",
                "        \"-vf\", \"scale=-2:720\",\n",
