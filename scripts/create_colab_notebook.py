    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "    - GPU (NVENC): ['-c:v', 'h264_nvenc', '-pix_fmt', 'yuv420p', '-preset', 'p4', '-cq', '23', '-spatial-aq', '1'] (1080p), ['-c:v', 'h264_nvenc', '-pix_fmt', 'yuv420p', '-preset', 'p4', '-cq', '24'] (720p).\n",
                "    - CPU: ['-c:v', 'libx264', '-pix_fmt', 'yuv420p', '-preset', 'veryfast', '-crf', '23', '-threads', '0'] (1080p), ['-c:v', 'libx264', '-pix_fmt', 'yuv420p', '-preset', 'veryfast', '-crf', '24', '-threads', '0'] (720p).\n",
                "    - Note: -pix_fmt yuv420p explicitly converts 10-bit sources into 8-bit YUV for universal NVENC/web compatibility.\n",
                "    \"\"\"\n",
                ...
                "                test_cmd = [ffmpeg_bin, \"-y\", \"-nostdin\", \"-f\", \"lavfi\", \"-i\", \"color=c=black:s=256x256:d=0.1\", \"-c:v\", \"h264_nvenc\", \"-pix_fmt\", \"yuv420p\", \"-f\", \"null\", \"-\"]\n",
