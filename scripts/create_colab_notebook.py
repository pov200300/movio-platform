    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "    print(f\"[HARDSUB] Burning Arabic subtitles into frames (NVENC): output_subbed.mp4 in {staging_dir}...\")\n",
                "    cmd = [\n",
                "        \"ffmpeg\", \"-y\",\n",
                "        \"-hwaccel\", \"cuda\",\n",
                "        \"-i\", ffmpeg_input,\n",
                ...
                "        print(f\"[HARDSUB] NVENC hardsubbing error ({proc.returncode}): {err_snippet}. Attempting CPU fallback (libx264 ultrafast)...\")\n",
                "        cmd_cpu = [\n",
                "            \"ffmpeg\", \"-y\",\n",
                "            \"-i\", ffmpeg_input,\n",
                "            \"-vf\", subtitles_filter,\n",
