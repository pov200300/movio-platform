    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "    \"\"\"Decode raw subtitle bytes prioritizing Arabic encodings (utf-8-sig, utf-8, cp1256, windows-1256, iso-8859-6).\"\"\"\n",
                ...
                "            try:\n",
                "                subprocess.run([ffmpeg_bin, '-y', '-i', temp_src, temp_ass], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, check=False)\n",
                ...
                "            return video_path\n",
                "\n",
                "        print(f\"[SUBS] ℹ️ Subtitle decoded using '{detected_encoding}' and re-encoded to UTF-8.\")\n",
                "    except Exception as e:\n",
