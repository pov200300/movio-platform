    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "PREFERRED_QUALITY = \"1080p\" # @param [\"1080p\", \"720p\", \"both\"]\n",
                "\n",
                ...
                "    target_q = \"1080p\" if quality in (\"both\", \"multi\") else quality\n",
                "    torrent = fetch_yts_torrent(meta[\"title\"], meta[\"year\"], target_imdb, target_q)\n",
                ...
                "\n",
                "    # Dynamically rename final video so streaming host registers the clean movie title\n",
                ...
                "            print(f\"[PIPELINE] Renamed video to dynamic title: {final_filename}\")\n",
                ...
                "\n",
                "    # 5. Quality Distribution & Multi-Server Upload\n",
                "    # 1080p -> Doodstream (Server 1), 720p -> Streamtape (Server 2), or both\n",
                "    active_quality = torrent.get(\"quality\", quality)\n",
                "    if quality in (\"both\", \"multi\", \"all\"):\n",
                "        upload_res = upload_to_multi_servers(burned_video, active_quality)\n",
                "    else:\n",
                "        upload_res = upload_by_quality(burned_video, active_quality)\n",
                "\n",
                ...
                "    return post_data\n",
                "\n",
                "def run_batch_pipeline(items, preferred_quality=\"1080p\"):\n",
