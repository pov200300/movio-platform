    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "    \"\"\"Query EZTV API for TV episode torrents with mirror failover and quality prioritization.\"\"\"\n",
                "    episode_tag = f\"S{season_num:02d}E{episode_num:02d}\"\n",
                ...
                "    print(f\"[EZTV] ✅ Selected release: '{selected_torrent.get('title')}' ({actual_quality})\")\n",
                "    return {\n",
