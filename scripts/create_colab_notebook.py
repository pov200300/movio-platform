    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "    buf_size = max_rate * 2\n",
                "    print(f\"[HARDSUB] Dynamic Bitrate Profile: duration={duration:.0f}s, source={source_bitrate/1000:.0f} kbps -> target={target_bitrate/1000:.0f} kbps, maxrate={max_rate/1000:.0f} kbps, bufsize={buf_size/1000:.0f} kbps\")\n",
                "\n",
                "    print(f\"[HARDSUB] Burning Arabic subtitles into frames (NVENC p6/cq20): output_subbed.mp4 in {staging_dir}...\")\n",
                "    cmd = [\n",
                "        \"ffmpeg\", \"-y\",\n",
                "        \"-i\", ffmpeg_input,\n",
                "        \"-vf\", subtitles_filter,\n",
                ...
                "        print(f\"[HARDSUB] NVENC hardsubbing error ({proc.returncode}): {err_snippet}. Attempting CPU fallback (libx264 faster / crf 20)...\")\n",
                "        cmd_cpu = [\n",
                "            \"ffmpeg\", \"-y\",\n",
                "            \"-i\", ffmpeg_input,\n",
                "            \"-vf\", subtitles_filter,\n",
