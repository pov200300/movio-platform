    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "    \"\"\"Convert SRT to ASS format with Arabic styling. Bypasses FFmpeg SRT demuxer issues.\"\"\"\n",
                "    header_lines = [\n",
                "        \"[Script Info]\",\n",
                "        \"ScriptType: v4.00+\",\n",
                "        \"PlayResX: 1920\",\n",
                ...
                "                timing_idx = i\n",
                "                break\n",
                "        if not timing_line or timing_idx < 0: continue\n",
                "        m = re.match(r'(\\d+):(\\d+):(\\d+)[,.](\\d+)\\s*-->\\s*(\\d+):(\\d+):(\\d+)[,.](\\d+)', timing_line)\n",
                "        if not m: continue\n",
