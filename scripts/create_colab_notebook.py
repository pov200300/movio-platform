    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "                if not srt_files:\n",
                "                    print(f\"[SUBS] No .srt files found in archive for {imdb_id}.\")\n",
                "                    return None\n",
                "\n",
                ...
                "                    for fname in srt_files:\n",
                "                        try:\n",
                "                            sample = z.read(fname)[:50000].decode(\"utf-8\", errors=\"ignore\")\n",
                ...
                "\n",
                "                if not target_filename:\n",
                "                    print(f\"[SUBS] None of the subtitle files in {slug}.zip contain Arabic characters. Rejecting.\")\n",
                "                    return None\n",
                "\n",
                ...
                "                        print(f\"[SUBS] ❌ Subtitle file '{out_srt}' does NOT contain Arabic characters! Rejecting.\")\n",
                "                        try: os.remove(out_srt)\n",
                "                        except Exception: pass\n",
                "                        return None\n",
                "                except Exception as e:\n",
                "                    print(f\"[SUBS] ⚠️ Error validating subtitle content: {e}\")\n",
                "                    return None\n",
                "\n",
                ...
                "            print(f\"[HARDSUB] ⚠️ Subtitle '{srt_path}' contains no Arabic Unicode characters; using original video.\")\n",
                "            return video_path\n",
                "    except Exception as e:\n",
